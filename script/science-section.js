const items = [
    {
        name: "地震", children: [
            ...
            { name: "不要再什麼規模前都加上芮氏了", content: "地震規模的種類", img: "", url: "1-4.html" },
            { name: "地震警報 快趴下！", content: "地震速報的原理", img: "", url: "1-5.html" },
            { name: "直下型地震、海溝型地震？", content: "地震的類型", img: "", url: "1-6.html" },
            { name: "耳鳴、地震雲？是地震的前兆嗎", content: "地震預測可行嗎", img: "", url: "1-7.html" },
            { name: "距離震央近，震度越大？", content: "深層地震的不自然震度分布", img: "", url: "1-8.html" },
        ]
    },
    {
        name: "海嘯", children: [
            { name: "海嘯是怎麼形成的", content: "海嘯的成因", img: "", url: "2-1.html" },
            { name: "海嘯來前海水一定會後退嗎", content: "海嘯常見的迷思", img: "", url: "2-2.html" },
            { name: "1 公尺的海嘯也有危險嗎", content: "海嘯的破壞力", img: "", url: "2-3.html" },
            { name: "台灣也會有海嘯嗎", content: "台灣過去的海嘯紀錄和未來可能發生的海嘯", img: "", url: "2-4.html" },
        ]
    },
]
